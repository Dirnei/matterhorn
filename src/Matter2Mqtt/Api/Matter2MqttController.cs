...
using Gen = Matter2Mqtt.Api.Generated;
...
/// </summary>
[ApiController]
public sealed class Matter2MqttController(GatewayRef gateway) : Gen.Matter2MqttControllerBase
{
    ...
    public override Task<ActionResult<Gen.BridgeInfo>> GetBridgeInfo() =>
        Task.FromResult<ActionResult<Gen.BridgeInfo>>(new Gen.BridgeInfo { Service = "matter2mqtt" });
